...
function saveUserState() {
  if (userInRoom && currentRoom && nameInput.value) {
    localStorage.setItem("chatUserState", JSON.stringify({
...
observer.observe(usersList, { childList: true, characterData: true, subtree: true });
observer.observe(roomList, { childList: true, characterData: true, subtree: true });